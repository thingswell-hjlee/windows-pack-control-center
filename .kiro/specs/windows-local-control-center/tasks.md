...
- [x] 1. Enhance NormalizedEvent model and database schema
  - [x] 1.1 Add missing fields to the NormalizedEvent model
  ...
  - [x] 1.2 Add missing database indexes and update DbContext configuration
  ...
  - [x] 1.3 Update TypeScript types to match the full Standard Event Schema
...
- [x] 2. Enhance MQTT Receiver Service
  - [x] 2.1 Add configurable MQTT settings from appsettings.json
  ...
  - [x] 2.2 Enhance reconnection logic with configurable interval
  ...
  - [x] 2.3 Add graceful handling of unknown topics and logging enhancements
...
- [x] 3. Enhance Event Normalizer Service
  - [x] 3.1 Implement full event normalization with all schema fields
  ...
  - [x] 3.2 Implement correct event_id generation rules (with and without track_id)
  ...
  - [x] 3.3 Implement bbox array-to-object conversion
  ...
  - [x] 3.4 Add structured logging for event processing metrics
...
- [x] 4. Checkpoint - Ensure all core backend services compile and tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Enhance Device Status Service
  - [x] 5.1 Add configurable heartbeat timeout and check interval
  ...
  - [x] 5.2 Handle device disabled status transitions
...
- [x] 6. Implement Camera Status Service
  - [x] 6.1 Create CameraStatusService with waterfall status checking
  ...
  - [x] 6.2 Add CameraStatusService configuration and registration
...
- [x] 7. Enhance REST API - Devices and Cameras
  - [x] 7.1 Add validation and conflict detection to Device endpoints
  ...
  - [x] 7.2 Add validation and conflict detection to Camera endpoints
  ...
  - [x] 7.3 Trigger MQTT reconnection on device MQTT field updates
...
- [x] 9. Enhance SignalR Hub with all message types
  - [x] 9.1 Add EventAcknowledged and EventMemoUpdated hub methods
